...
function renderMunicipio(ctx, state) {
  ...
  if (hasPiezas) {
    ...
    for (const it of items) {
      ...
      // 2026-05-31 — Etiquetas de barrio SOLO en hover (petición usuario:
      // sin títulos/info permanentes sobre las unidades; el nombre + edif
      // aparece al pasar por encima). El tap sigue funcionando vía el
      // hit-test de polígono en handleTap, independiente de la etiqueta.
      if (!isHover) continue;
